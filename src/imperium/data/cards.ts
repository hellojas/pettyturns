...
export const IMP_CARD_DEFS: Record<CardDefId, ImpCardDef> = {
  ...
  // --- Third batch (all VERIFY: costs/counts/icons/effects are placeholders) ---
  // Emperor — martial + court economy
  sardaukarCommander: {
    id: 'sardaukarCommander',
  ...
  imperialThrone: {
    ...
    count: 1,
    icons: ['emperor', 'landsraad', 'city'],
    agentGains: { troops: 2, solari: 2 },
    revealGains: { persuasion: 3 },
    source: 'imperium',
  },

  // Spacing Guild — logistics + spice logistics
  guildNavigator: {
    id: 'guildNavigator',
    ...
    count: 1,
    icons: ['spacingGuild', 'spiceTrade'],
    agentGains: { spice: 2, drawCards: 1 },
    agentCost: { influenceRequired: { faction: 'spacingGuild', min: 1 } },
    revealGains: { persuasion: 2 },
    source: 'imperium',
  },
  guildContact: {
    ...
    cost: 2,
    count: 2,
    icons: ['spacingGuild', 'landsraad'],
    agentGains: { solari: 1, drawCards: 1 },
    revealGains: { persuasion: 1 },
    source: 'imperium',
  },

  // Bene Gesserit — cards + influence manipulation
  beneGesseritAcolyte: {
    id: 'beneGesseritAcolyte',
    name: 'Bene Gesserit Acolyte',
    cost: 2,
    count: 2,
    icons: ['beneGesserit'],
    agentGains: { drawCards: 1 },
  ...
  hiddenSisterhood: {
    id: 'hiddenSisterhood',
    name: 'Hidden Sisterhood',
    cost: 5,
    count: 1,
    icons: ['beneGesserit', 'city'],
    agentGains: { intrigueCards: 1, stealIntrigueAt: 3 },
    revealGains: { persuasion: 1 },
    source: 'imperium',
  },

  // Fremen — troops + water economy
  fedaykinWarrior: {
    id: 'fedaykinWarrior',
    name: 'Fedaykin Warrior',
    cost: 4,
    count: 2,
    icons: ['fremen', 'city'],
    agentGains: { troops: 2 },
  ...
  sietchElders: {
    ...
    count: 1,
    icons: ['fremen', 'city'],
    agentGains: { water: 1, anyInfluence: 1, drawCards: 1 },
    revealGains: { persuasion: 1, swords: 1 },
    source: 'imperium',
  },

  // Landsraad / CHOAM — persuasion & intrigue engines
  spyNetwork: {
    id: 'spyNetwork',
    name: 'Spy Network',
    cost: 3,
    count: 1,
    icons: ['landsraad'],
    agentGains: { intrigueCards: 1, stealIntrigueAt: 4 },
    revealGains: { persuasion: 1 },
    source: 'imperium',
  },
  choamShares: {
